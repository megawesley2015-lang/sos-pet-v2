...
export default function PrestadoresPage() {
  ...
  // Atualizar categoria quando mudar na URL
  useEffect(() => {
    if (categoriaParam) {
    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-16 bg-gradient-to-br from-[#20B2AA] to-[#1a9e97] rounded-3xl p-8 md:p-12 text-center text-white">
          ...
          <Link
            href="/cadastro"
            className="inline-block bg-[#FF6B35] hover:bg-[#e85a2a] text-white px-8 py-4 rounded-xl font-bold transition-all hover:scale-105"
          >
